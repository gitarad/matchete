...
VerificationTest[
	CG[del@ SU2@ fund, {i, i}] // ContractCGs
,
	2
,
	TestID-> "CGContractions: Single SU(2) \[Delta] trace"
]


VerificationTest[
	CG[t@ SU2@ fund, {a, i, i}] // ContractCGs
,
	0
,
	TestID-> "CGContractions: Single SU(2) generator trace"
]


VerificationTest[
	3 CG[del@ SU2@ fund, {i, i}] // ContractCGs
,
	6
,
	TestID-> "CGContractions: constant times SU(2) \[Delta] trace"
]
...
VerificationTest[Module[{a, b, c},
	f2[a, b ,c]^2// ContractCGs
],
	6
,
	TestID-> "CGContractions: SU(2) f power contraction"
]
